...
export default class Player
{
	constructor({ app }) {
		...
		this.healthBar.drawRect(
			margin, app.screen.height - barHeight - margin / 2,
			this.healthBar.initialWidth, barHeight
		);
	...
	update()
	{
		...
		if(mouse.buttons !== this.lastMouseButoon)
		{
			this.shooting.shoot = mouse.buttons !== 0;
			this.lastMouseButoon = mouse.buttons;
		}
